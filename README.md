...
![developer](https://img.shields.io/badge/Developed%20By%20%3A-Sumit%20Kumar%20%26%20Chason%20Ed-red)
---
## What's New
- Modern, dark-mode UI for a more visually appealing and user-friendly experience.
- Refined UI elements for a more cohesive and professional look.
...
## Disclaimer
This project is developed for demo purpose and it's not supposed to be used in real application. The new UI is also a demo and can be further improved.

## Feedback
Any suggestion and feedback is welcome. You can message me on facebook
- [Contact on Facebook](https://fb.com/sumit.luv)
- [Subscribe my Channel LazyCoder On Youtube](https://youtube.com/lazycoderonline)
- [Contact Chason Ed on Github](https://github.com/ChasonEd)
